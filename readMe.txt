...
a GUI program to anticipate and compensate for user errors,
...
Modify page to validate all data entered by the user using the jQuery Validation
...
assignment.
Explore the various jQuery Validation plugin options carefully. Read the text, study
